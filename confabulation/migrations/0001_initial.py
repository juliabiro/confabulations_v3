    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analysis', models.ManyToManyField(to='confabulation.AnalysisPoint')),
                ('photos', models.ManyToManyField(to='confabulation.Photo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recording', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='confabulation.Recording')),
            ],
        ),
        migrations.AddField(
