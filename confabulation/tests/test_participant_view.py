...
class ParticipantView(TestCase):
    ...
    def test_participant_view(self):
        ...
        self.assertContains(response, '/v1/confabulations/thumbnails/elso')
        self.assertContains(response, '/v1/confabulations/thumbnails/masodik')
        self.assertContains(response, '/v1/confabulations/thumbnails/harmadik')
